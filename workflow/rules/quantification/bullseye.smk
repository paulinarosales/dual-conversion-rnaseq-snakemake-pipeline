...
# PENDING CHANGES: make the control mtx conditional
    input:
        ...
        refFlatGTF = _input_refFlat
    output:
        'results/site_calling/against_ctrl/{sample_type}_wt-vs-mut_Chase-time_{chase_time_h}_Bio-rep_{bio_rep}/{sample_type}_wt-vs-mut_Chase-time_{chase_time_h}_Bio-rep_{bio_rep}_m6A_sites.bed'
    log:
